...
class PemohonController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('surat_pemohonan')) {
            ...
            $fotoName = $extension;
            $surat_pemohonan->move(storage_path(
                'app/public/berkas/surat_pemohonan',
                $request->file('surat_pemohonan')->getClientOriginalName()
            ), $fotoName);
        ...
        if ($request->hasFile('pas_foto')) {
            ...
            $fotoName = $extension;
            $pas_foto->move(storage_path(
                'app/public/berkas/pas_foto',
                $request->file('pas_foto')->getClientOriginalName()
            ), $fotoName);
        ...
        if ($request->hasFile('ktp')) {
            ...
            $fotoName = $extension;
            $ktp->move(storage_path(
                'app/public/berkas/ktp',
        ...
        if ($request->hasFile('ijazah')) {
            ...
            $fotoName = $extension;
            $ijazah->move(storage_path(
                'app/public/berkas/ijazah',
                $request->file('ijazah')->getClientOriginalName()
            ), $fotoName);
        ...
        if ($request->hasFile('surat_tanda_regist')) {
            ...
            $fotoName = $extension;
            $surat_tanda_regist->move(storage_path(
                'app/public/berkas/surat_tanda_regist',
                $request->file('surat_tanda_regist')->getClientOriginalName()
            ), $fotoName);
        ...
        if ($request->hasFile('surat_persetujuan_kerja')) {
            ...
            $fotoName = $extension;
            $surat_persetujuan_kerja->move(storage_path(
                'app/public/berkas/surat_persetujuan_kerja',
                $request->file('surat_persetujuan_kerja')->getClientOriginalName()
            ), $fotoName);
        ...
        if ($request->hasFile('surat_pernyataan_praktik')) {
            ...
            $fotoName = $extension;
            $surat_pernyataan_praktik->move(storage_path(
                'app/public/berkas/surat_pernyataan_praktik',
                $request->file('surat_pernyataan_praktik')->getClientOriginalName()
            ), $fotoName);
        ...
        if ($request->hasFile('surat_sehat')) {
            ...
            $fotoName = $extension;
            $surat_sehat->move(storage_path(
                'app/public/berkas/surat_sehat',
                $request->file('surat_sehat')->getClientOriginalName()
            ), $fotoName);
        ...
        if ($request->hasFile('surat_rekomendasi_profesi')) {
            ...
            $fotoName = $extension;
            $surat_rekomendasi_profesi->move(storage_path(
                'app/public/berkas/surat_rekomendasi_profesi',
                $request->file('surat_rekomendasi_profesi')->getClientOriginalName()
            ), $fotoName);
        ...
        if ($request->hasFile('surat_keterangan_praktek')) {
            ...
            $fotoName = $extension;
            $surat_keterangan_praktek->move(storage_path(
                'app/public/berkas/surat_keterangan_praktek',
                $request->file('surat_keterangan_praktek')->getClientOriginalName()
            ), $fotoName);
