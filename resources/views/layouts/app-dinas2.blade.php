...
<head>
    ...
    <title>Admin Dinas - Tecnopolis</title>
        ...
        <div id="main" class="layout-horizontal">
            <header class="mb-5">
                <div class="header-top">
                    <div class="container">
                        <div class="logo">
                            <a href="/dinas"><img src="{{ asset('images/logo.png') }}" width="25" height="25"
                                    alt="Logo"></a>
                        </div>
                        <div class="header-top-right">
                            <div class="permohonan dropdown">
                                <a href="/dinas" class=" d-flex align-items-center ">
                                    <div class="text">
                                        <h6 class="user-dropdown-name">Dashboard</h6>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="permohonan dropdown">
                                <a href="/chatify" class=" d-flex align-items-center ">
                                    <div class="text">
                            ...
                            <div class="permohonan dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-lg"
                                    ...
                                    <li><a class="dropdown-item" href="/dinas/tracking/pendirian">Perizinan
                                            Pendirian</a></li>
                                    <li><a class="dropdown-item" href="/dinas/tracking/penyelenggaraan">Perizinan
                            ...
                            <div class="dropdown">
                                <a href="#" id="topbarUserDropdown"
                                    class="user-dropdown d-flex align-items-center" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <div class="avatar avatar-md2">
                                        <img src="{{ asset('images/orang.png') }}" alt="Avatar">
                                    </div>
                                    <div class="text">
                                        <img src="{{ asset('nonUser/img/Account.png') }}" alt="" width="50"
                                            height="50">
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end shadow-lg"
