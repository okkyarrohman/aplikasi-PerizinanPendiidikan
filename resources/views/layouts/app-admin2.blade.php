        ...
        <div id="main" class="layout-horizontal">
            <header class="mb-5">
                <div class="header-top">
                    <div class="container">
                        <div class="logo">
                            <a href="/admin"><img src="{{ asset('images/logo.png') }}" width="25" height="25"
                                    alt="Logo"></a>
                        </div>
                        <div class="header-top-right">
                            ...
                            <div class="permohonan dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-lg"
                                    aria-labelledby="topbarUserDropdown">
                                    <li><a class="dropdown-item" href="/admin/tracking/pendirian">Perizinan
                                            Pendirian</a></li>
                                    <li><a class="dropdown-item" href="/admin/tracking/penyelenggaraan">Perizinan
                                            Penyelenggaraan</a></li>
                                </ul>
                            </div>
