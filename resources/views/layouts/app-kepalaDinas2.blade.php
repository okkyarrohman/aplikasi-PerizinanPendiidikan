...
<head>
    ...
    <title>Kepala Dinas - Tecnopolis</title>
                    ...
                    <div class="container">
                        ...
                        <div class="header-top-right">
                            <div class="permohonan dropdown">
                                <a href="/kepala-dinas" class=" d-flex align-items-center ">
                                    <div class="text">
                            ...
                            <div class="permohonan dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-lg"
                                    aria-labelledby="topbarUserDropdown">
                                    <li><a class="dropdown-item" href="/kepala-dinas/tracking/pendirian">Perizinan
                                            Pendirian</a></li>
                                    <li><a class="dropdown-item" href="/kepala-dinas/tracking/penyelenggaraan">Perizinan
                                            Penyelenggaraan</a></li>
                                </ul>
                            </div>
