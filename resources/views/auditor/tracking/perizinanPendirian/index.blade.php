    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/auditor/tracking/pendirian/dokumen_valid_pendirian">
                            <h4>Dokumen Valid</h4>
                        </a>
                    </div>
                    <div class="group d-flex m-4 justify-content-lg-around">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/auditor/tracking/pendirian/sedang_disurvey_pendirian">
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/auditor/tracking/pendirian/telah_disurvey_pendirian">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/auditor/tracking/pendirian/dokumen_sesuai_pendirian">
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/auditor/tracking/pendirian/tolak_dokumen_pendirian">
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/auditor/tracking/pendirian/ttd_kepala_dinas_pendirian">
