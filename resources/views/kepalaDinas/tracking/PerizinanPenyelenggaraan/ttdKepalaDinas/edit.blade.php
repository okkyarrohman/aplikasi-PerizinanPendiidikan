            ...
            <div class="col-md-12 ">
                <div class="card align-items-center">
                    <div class="card-header align-items-center">
                        <h4 class="card-title align-items-center">Tanda Tangan Permohonan Perizinan Penyelenggaraan
                        </h4>
                    </div>
                </div>
            </div>
            <form class="form form-vertical" method="POST" action="{{ route('permohonanSelesaiPenyelenggaraan.update') }}"
                ...
                <select name="status_dokumen" id="" class="form-select form-select" hidden>
                    <option value="Permohonan Selesai" selected>Tanda Tangan</option>
                </select>
