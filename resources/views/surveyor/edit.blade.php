...
@section('content')
    <form action="{{ route('surveyor.update') }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="child-2">
                ...
                <div class="mb-2 m-5 w-50">
                    ...
                    <input type="number" name="nomor_berkas" class="form-control" id="exampleInputEmail1"
                        aria-describedby="emailHelp" value="{{ $perizinan->nomor_berkas }}" disabled>
                </div>
            </div>
        ...
        <div class="parent-2 m-3 d-flex">
            ...
            <div class="mb-2 m-5 w-75">
                <label for="exampleInputEmail1" class="form-label">Upload Dokumen Hasil Survey</label>
                <input type="file" name="dokumen_survey" class="form-control" id="exampleInputEmail1"
            ...
            <div class="mb-3 m-5 w-50">
                ...
                <select id="disabledSelect" class="form-select" name="status_permohonan">
                    <option value="Telah Disurvey">Survei Selesai</option>
                </select>
            </div>
        </div>
