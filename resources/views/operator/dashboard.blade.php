                ...
                <div class="card">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                <h6 class="text-muted font-semibold">Checking Berkas Operator</h6>
                ...
                <div class="card">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                <h6 class="text-muted font-semibold">Dokumen Tidak Valid</h6>
                                <h6 class="font-extrabold mb-0">{{ $totalDokumenTidakValid }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
