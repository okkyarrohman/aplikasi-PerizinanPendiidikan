    ...
    <div class="container">
        <div class="card">
            <div class="title d-flex m-4 justify-content-center align-items-center">
                <h2> Monitoring Perizinan Penyelenggaraan</h2>
            </div>
        </div>
        <br>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/penyelenggaraan/checking_berkas_operator_penyelenggaraan">
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/penyelenggaraan/dokumen_valid_penyelenggaraan">
                            <h4>Dokumen Valid</h4>
                        </a>
                    </div>
                    <div class="group d-flex m-4 justify-content-lg-around">
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/penyelenggaraan/dokumen_tidak_valid_penyelenggaraan">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/penyelenggaraan/sedang_disurvey_penyelenggaraan">
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/penyelenggaraan/telah_disurvey_penyelenggaraan">
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/penyelenggaraan/checking_berkas_verifikator_penyelenggaraan">
