    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/pendirian/checking_berkas_operator_pendirian">
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/pendirian/dokumen_valid_pendirian">
                            <h4>Dokumen Valid</h4>
                        </a>
                    </div>
                    <div class="group d-flex m-4 justify-content-lg-around">
                        ...
                        <div class="next">
                            <a href="/walikota/tracking/pendirian/dokumen_valid_pendirian" class="btn btn-primary">-></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/pendirian/dokumen_tidak_valid_pendirian">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/pendirian/sedang_disurvey_pendirian">
                    ...
                    <div class="group d-flex m-4 justify-content-lg-around">
                        ...
                        <div class="next">
                            <a href="/walikota/tracking/pendirian/sedang_disurvey_pendirian" class="btn btn-primary">-></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/pendirian/telah_disurvey_pendirian">
                    ...
                    <div class="group d-flex m-4 justify-content-lg-around">
                        ...
                        <div class="next">
                            <a href="/walikota/tracking/pendirian/telah_disurvey_pendirian" class="btn btn-primary">-></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card shadow-lg">
                    <div class="title-card m-4">
                        <a href="/walikota/tracking/pendirian/checking_berkas_verifikator_pendirian">
